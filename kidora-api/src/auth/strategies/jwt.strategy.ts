...
// `email` is nullable: an account created from a phone number has none.
interface Tenancy { role: Role; email: string | null; schoolId: string | null; districtId: string | null; active: boolean }
