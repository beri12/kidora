...
function Body({ d }: { d: Data }) {
  ...
  const quick = [
    ["Add Student", UserPlus, "/school/students/new"], ["Add Teacher", UserRoundPlus, "/school/teachers/new"], ["Create Course", FilePlus2, "/dashboard/teacher/create-course/basic-info"],
